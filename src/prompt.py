...
# kzaporojets - should work
extract_entiry_centric_kg_en_v2 = """
You are a knowledge graph extraction assistant, responsible for extracting attributes and relationships related to a specified entity from the text.
...
3. The head entity of each relationship MUST be the specified entity.
4. Remove duplicate attributes and relationships.

The final output format MUST be valid JSON and MUST follow this structure exactly:
...
# kzaporoj - new format with json
judge_sim_entity_en = """
You are a knowledge graph entity disambiguation assistant responsible for determining whether two entities are essentially the same entity.

You MUST output your answer strictly in JSON format.

For example:
Entity 1: "name": "Henan Business Daily", "type": "Media Organization", "description": "A commercial newspaper in Henan Province that provides news and information reporting."
Entity 2: "name": "Top News·Henan Business Daily", "type": "Organization Name", "description": "A news media organization located in Henan Province, responsible for reporting important local and national news and information."
...
Notes:
1. First judge based on name and type; if potentially the same, analyze descriptions carefully.
2. Your output MUST be valid JSON.
3. If they are the same entity, output:
   {{"result": true}}
4. If they are not the same entity, output:
   {{"result": false}}
"""

# kzaporoj- this is invalid
# judge_sim_entity_en = """
